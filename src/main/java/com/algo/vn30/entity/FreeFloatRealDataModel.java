...
@MappedSuperclass
public class FreeFloatRealDataModel {
    @Id
    ...
    @Column(name = "weight_market_cap")
    private Double weight_market_cap;
    ...
    public Double getWeight_market_cap() { return weight_market_cap; }

    public void setWeight_market_cap(Double weight_market_cap) { this.weight_market_cap = weight_market_cap; }
